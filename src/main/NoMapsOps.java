...
public class NoMapsOps {
   ...
   /*     
        ...
        var tups = new int[] {7000}; 
        
        for(int s = 0; s< tups.length ; s++){

        int tup [] = new int [] {7000,1,7000};
        out.println ();
        ...
        for(int i = 0; i <=10 ; i ++) {
            ...
            //Simple join
        	 ...
        	 var join  = prof.join("id","profId",teach);         
        	 Long end = System.currentTimeMillis();
        	 Long time_elapsed = end - start;
        	 joinTime.add(time_elapsed);
        	 System.out.println("time_elapsed in ms for simple join"+time_elapsed);
